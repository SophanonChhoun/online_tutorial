  ...
  methods: {
    submit: function submit() {
      ...
      this.$validator.validateAll().then(function (result) {
        ...
        var save = true;
        _this.data.category_id = _this.data.category.id;

        if (result && save) {
          console.log(_this.id);
          axios.post('/admin/course/update/' + _this.id, _this.data).then(function (response) {
    ...
    addLessons: function addLessons() {
...
/***/ 10:
/*!*******************************************!*\
  !*** multi ./resources/js/course/edit.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/chhounsophanon/Desktop/mobile_api/hotel_management/Desktop/Laravel/project/hotel_system/resources/js/course/edit.js */"./resources/js/course/edit.js");
